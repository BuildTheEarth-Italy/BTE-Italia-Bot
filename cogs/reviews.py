...
class Reviews(commands.Cog, description='Builder reviewing tools.'):
    ...
    @commands.command(
        name='unsafe_accetta_revisione',
        description='Approves a player to Newbie.',
        brief='Approves a player to Newbie.',
        usage="[member] [minecraft_name]",
        aliases=['uar'])
